...
def checker(buttons):
    ...
    if buttons["text"]=="" and click==True:
       ...
       click=False
         ...
         tkinter.messagebox.showinfo("Winner X","Just won a game")
         ...
         tkinter.messagebox.showinfo("Winner O","Just won a game")
         
    else:
         tkinter.messagebox.showinfo( "DRAW","Match draw play again")
